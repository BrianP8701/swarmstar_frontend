...
from src.utils.database import get_user, get_user_profile, get_user_swarm
...
def update_user_swarm_in_ui(swarm_id: str) -> None:
    ...
    if user.current_swarm_id == swarm_id:
        asyncio.create_task(manager.send_personal_message({
            "type": "update_swarm",
            "swarm": get_user_swarm(swarm_id).model_dump()
        }, user_swarm.owner))

def update_user_in_ui(swarm_id: str) -> None:
    pass

def update_swarm_chat_in_ui(swarm_id: str, chat_id: str) -> None:
    pass
